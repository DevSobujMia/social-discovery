  ...
  return (
    <main className="min-h-screen bg-surface-950 text-white px-4 py-10">
      <article className="max-w-2xl mx-auto space-y-5 text-sm text-surface-300 leading-relaxed">
        ...
        <p>
          City Host collects the smallest amount of information needed to show you shared trips
          in a city and keep that chat if you close the tab.
        </p>

        <h2 className="text-base font-bold text-white pt-2">What we collect</h2>
        <ul className="list-disc pl-5 space-y-1">
          <li>First name, approximate age, and the city you are in (from an ad or your device).</li>
          <li>Trips you share and messages you send on this site.</li>
        ...
        <p>
          To show locals who is visiting their city, to operate on-site chat, to notify you of a
          reply on the channel you picked, and to measure which ads work. We do not sell your
          contact details.
        </p>

        <h2 className="text-base font-bold text-white pt-2">Your rights</h2>
        <p>
          You may ask us to delete your conversation and contact details at any time. Write to
          support from the site. We keep unverified visits for a limited period so a returning
